...
$mail->Username   = 'enquiry@qcondosca.com';       // SMTP username
$mail->Password   = "Qcondosca@2210";                           // SMTP password
...
$question_1 = $_REQUEST['q1'];
$question_2 = $_REQUEST['q2'];

//Recipients
$mail->setFrom('enquiry@qcondosca.com', 'Contact Us');
$mail->addAddress($contact_email, $form_name); 
$mail->addAddress('enquiry@qcondosca.com', 'Contact Us'); 
...
// $database = "qcondosca";
 ...
 $username = "u768511311_qcondos";
 $password = "Qcondos@2210";
 $database = "u768511311_qcondos";
...
if (!$conn) {
 ...
 $sql = "INSERT INTO `contact` (`name`, `number`, `email`, `q1`, `q2` ) VALUES
 ('$form_name', '$contact_phone', '$contact_email', '$question_1' ,'$question_2');";
																		...
																		<td align="left" class="link-wrap" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; padding-bottom: 20px; word-break: break-word;">
																		   ...
																		   Dear <b>'.$form_name.'</b><br>
																			  ...
																			  <ul>
																				 ...
																				 <li><strong>Contact Number</strong> - '.$contact_phone.'</li>
																				 <li><strong>Are you</strong> - '.$question_1.'</li>
																				 <li><strong>Are you a Realtor?</strong> -'. $question_2.'</li>
																			  </ul>
																			  <br>
																		   </div>
																		</td>
															...
															<tr>
															   <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
																  <div style="font-family:OpenSans, Helvetica, Tahoma, Arial, sans-serif;font-size:12px;font-weight:400;line-height:20px;text-align:center;color:#4F4F4F;">
																	 <br /> &copy; 2025 Q condos. All rights reserved.
																	 <br />
																  </div>
															   </td>
															</tr>
...
?>
<script language="javascript">
window.open("https://qcondosca.com/","_self");
</script>